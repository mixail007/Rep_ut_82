...
Процедура ДействияФормыОтчетСформировать(Кнопка)
	...
	если ДеревоРазличий.Строки.Количество()=0 тогда N=0;
	иначе	
		N = 0;
...
//========================По настройке===========================================	
	...
	КонецЕсли;
	//
	//j=найти(текстГде,"ИТОГИ");
	//если j>0 тогда // наши итоги убираем!
	//	если i=0 тогда
	//		текстГде = прав(текстГде, стрДлина(текстГде) - j +1);
	//	Иначе
	//		текстГде="";
	...
	//	Запрос1.Текст = стрЗаменить(Запрос1.Текст,	"//ИТОГИ
	//				|//	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ Код),
	//				|//	СУММА(ТолькоВтерминале),
	//				|//	СУММА(ТолькоВ1С),
	//				|//	СУММА(Одинаково),
	//				|//	СУММА(Различных)
	//				|//ПО  ВидТовара", текстГде);
	//Иначе
	//		Запрос1.Текст = стрЗаменить(Запрос1.Текст,	"//ИТОГИ
	//				|//	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ Код),
	//				|//	СУММА(ТолькоВтерминале),
