...
//+++ 02.08.2018---------------ТОЛЬКО 1 раз!----------------------------------		
	//	Пока Найти(СтрокаНазначениеПлатежа, "№")>0 Цикл
	Если Найти(СтрокаНазначениеПлатежа, "№")>0 тогда
			НомерСимвола = Найти(СтрокаНазначениеПлатежа, "№");
			
			НаборЦифр = "";
			СчитаноСимволовПослеЗнакаN = 0;
			Для i=НомерСимвола+1 По СтрДлина(СтрокаНазначениеПлатежа) Цикл
				...
				Если Найти("0123456789", Символ) = 0 Тогда
					Если НЕ НаборЦифр = "" Тогда
						...
						КонецЕсли;
						СтрокаНазначениеПлатежа = Прав(СтрокаНазначениеПлатежа, СтрДлина(СтрокаНазначениеПлатежа) - (НомерСимвола + СчитаноСимволовПослеЗнакаN));
...
//+++ 02.08.2018 --- только 1 раз, а не в бесконечном цикле!--------------------
