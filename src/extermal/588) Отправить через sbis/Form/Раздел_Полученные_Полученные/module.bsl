...
// функция обновляет контент для раздела Полученные	
	//Возврат сбисПолучитьФорму("ФормаГлавноеОкно").ПерейтиВРаздел("АккордеонДокОтгрВх11");
...
// Процедура обновляет панель массовых операций, панель фильтра, контекстное меню при смене раздела	
	...
	сбисУстановитьКонтекстноеМеню(ГлавноеОкно, сбисЭлементФормы(ГлавноеОкно,"Таблица_РеестрДокументов"), "КонтекстноеМенюПолученные");
	сбисУстановитьКонтекстноеМеню(ГлавноеОкно, сбисЭлементФормы(ГлавноеОкно,"Таблица_РеестрСобытий"), "КонтекстноеМенюПолученныеРеестрСобытий");
