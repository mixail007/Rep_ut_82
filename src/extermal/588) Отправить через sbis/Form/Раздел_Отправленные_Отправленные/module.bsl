...
// Процедура обновляет панель массовых операций, панель фильтра, контекстное меню при смене раздела		
	...
	сбисУстановитьКонтекстноеМеню(ГлавноеОкно, сбисЭлементФормы(ГлавноеОкно,"Таблица_РеестрДокументов"), "КонтекстноеМенюОтправленные");
	сбисУстановитьКонтекстноеМеню(ГлавноеОкно, сбисЭлементФормы(ГлавноеОкно,"Таблица_РеестрСобытий"), "КонтекстноеМенюОтправленныеРеестрСобытий");
