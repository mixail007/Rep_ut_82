...
Процедура ОтчетВывести()
	...
	ПостроительОтчетаОтчет.ТекстЗаголовка = "Отчет по поступлениям за "  + Формат(ДатаОтчета,  "ДФ=""дд ММММ гггг 'г.'""");
...
Процедура ОтчетИнициализация()
	...
	|	Ссылка.Дата
	|ИТОГИ
	|	Сумма(Отгружено) ПО Ссылка.Контрагент, НомерАвто, Склад
	|";
