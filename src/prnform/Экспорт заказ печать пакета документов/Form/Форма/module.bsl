...
Процедура КнопкаВыполнитьНажатие(Кнопка)
	...
	Если ФлСпецификация И КолСпецификация > 0 Тогда
		...
		//Иначе
			ПечатьДокумента("Экспорт заказ печать спецификации", СсылкаНаОбъект, КолСпецификация, СокрЛП(НомерДокументаШинтрейд));
		//КонецЕсли;
	КонецЕсли;
	...
	Если ФлИнвойс И КолИнвойс > 0 Тогда
		 ПечатьДокумента("Экспорт заказ печать коммерческий инвойс", СсылкаНаОбъект,КолИнвойс, СокрЛП(НомерДокументаШинтрейд));
	 КонецЕсли;
	 
	 Если ФлУпаковочныйЛист И КолУпаковочныйЛист > 0 Тогда
		 ПечатьДокумента("Экспорт заказ печать упаковочный лист", СсылкаНаОбъект,КолУпаковочныйЛист, СокрЛП(НомерДокументаШинтрейд));
	 КонецЕсли;
