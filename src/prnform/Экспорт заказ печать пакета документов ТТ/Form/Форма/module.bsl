...
Процедура КнопкаВыполнитьНажатие(Кнопка)
	...
	Если ФлСпецификация И КолСпецификация > 0 Тогда
		...
		//Иначе
			ПечатьДокумента("Экспорт заказ печать спецификации ТТ", СсылкаНаОбъект, КолСпецификация, СокрЛП(НомерДокументаШинтрейд));
		//КонецЕсли;
	КонецЕсли;
	...
	Если ФлИнвойс И КолИнвойс > 0 Тогда
		 ПечатьДокумента("Экспорт заказ печать коммерческий инвойс ТТ", СсылкаНаОбъект,КолИнвойс, СокрЛП(НомерДокументаШинтрейд));
	 КонецЕсли;
	 
	 Если ФлУпаковочныйЛист И КолУпаковочныйЛист > 0 Тогда
		 ПечатьДокумента("Экспорт заказ печать упаковочный лист ТТ", СсылкаНаОбъект,КолУпаковочныйЛист, СокрЛП(НомерДокументаШинтрейд));
	 КонецЕсли;
