...
Процедура ПечатьДокумента(СтруктураШапки,ДокументОприходования,КоличествоКопий=1,НаПринтер=Истина);
	...
	//|Выбрать 	Партии.Номенклатура.Наименование Как Наименование, 
	//|			Партии.Номенклатура.Код Как Код,
	//|			Партии.Номенклатура.БазоваяЕдиницаИзмерения.Наименование Как ЕдиницаИзмерения,
	...
	//|			По
	//|			Док.Номенклатура = Партии.Номенклатура
	//|			Где Док.Ссылка = &Ссылка
	//|			и
	//|			Регистратор=&ссылка";
