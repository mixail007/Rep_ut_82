...
Функция ПечатьДокумента(СсылкаНаОбъект)
	...
	Если ДваЯзыка Тогда
		//Если ОрганизацияТТ тогда
			...
			ОбластьШапка.Параметры.ФактАдресГрузоотправителя = "RM2105 QD3417 TREND CENTRE 29-31 CHEUNG LEE ST,CHAI WAN,HK";
			ОбластьШапка.Параметры.ПродавецНаименование = "Tire Technology Co LTD";
			ОбластьШапка.Параметры.ФактАдресПродавца = "RM2105 QD3417 TREND CENTRE 29-31 CHEUNG LEE ST,CHAI WAN,HK";
