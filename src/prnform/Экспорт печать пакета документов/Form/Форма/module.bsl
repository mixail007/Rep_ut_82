...
Процедура КнопкаВыполнитьНажатие(Кнопка)
	...
	Если ФлСпецификация И КолСпецификация > 0 Тогда
		...
		Иначе
			ПечатьДокумента("Экспорт Печать спецификации", СсылкаСпецификация, КолСпецификация, СокрЛП(НомерДокументаШинтрейд));
		КонецЕсли;
	КонецЕсли;
	...
	Если ФлИнвойс И КолИнвойс > 0 Тогда
		 ПечатьДокумента("Экспорт Печать Коммерческий инвойс", СсылкаНаОбъект,КолИнвойс, СокрЛП(НомерДокументаШинтрейд));
	 КонецЕсли;
	 
	 Если ФлУпаковочныйЛист И КолУпаковочныйЛист > 0 Тогда
		 ПечатьДокумента("Экспорт Печать Упаковочный лист", СсылкаНаОбъект,КолУпаковочныйЛист, СокрЛП(НомерДокументаШинтрейд));
	 КонецЕсли;
