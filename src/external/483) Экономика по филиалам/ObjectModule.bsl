Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Иначе
		...
		ИначеЕсли 
			...
			ОтборПодразделение.ПравоеЗначение=ДоступноеПодразделение;			
			//ИначеЕсли 
			//СтрЧислоВхождений(ПараметрыСеанса.ТекущийПользователь.Наименование, "Серков")> 0 Тогда 
			//ДоступныеПодразделения = Новый Массив;
			//ДоступныеПодразделения.Добавить(Справочники.Подразделения.НайтиПоКоду("00138")); // Екат-Б
			//ДоступныеПодразделения.Добавить(Справочники.Подразделения.НайтиПоКоду("00112")); // Сп-Б
			//ДоступныеПодразделения.Добавить(Справочники.Подразделения.НайтиПоКоду("00106")); // ростов
			//ОтборПодразделение=КомпоновщикНастроек.Настройки.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
			//ОтборПодразделение.Использование=Истина;
			//ОтборПодразделение.ВидСравнения=ВидСравненияКомпоновкиДанных.ВСписке;
			//ОтборПодразделение.ЛевоеЗначение=Новый ПолеКомпоновкиДанных("Подразделение");
			//ОтборПодразделение.ПравоеЗначение=ДоступныеПодразделения;	
