...
Процедура КнопкаВыполнитьНажатие(Кнопка)
	...
	Если Контрагент.ЭтоГруппа Тогда
		Сообщить("Карточку нельзя сформировать для группы элементов!", СтатусСообщения.Важное);
		Возврат;
	КонецЕСли;
...
Процедура ПриОткрытии()
	сигнал();
	Предупреждение("Печатная форма ""Карточка контрагента""
				|c 04.09.2012 - доступна из формы самого Контрагента!
				| Печать -> Карточка",30);
КонецПроцедуры
