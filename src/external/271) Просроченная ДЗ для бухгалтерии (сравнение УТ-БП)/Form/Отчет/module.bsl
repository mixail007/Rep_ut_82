		...
		Для каждого строкаПодразделение Из ТаблицаПодразделений Цикл
			...
			Для каждого строкаМенеджер Из ВыбранныеМенеджеры Цикл
				...
				Для каждого  строкаКонтрагент ИЗ  ВыбранныеКонтрагенты Цикл
					...
					ОбластьКонтрагент.Параметры.КонтрагентИКод = ?(ЗначениеЗаполнено(строкаКонтрагент.Контрагент),строкаКонтрагент.Контрагент.Код,"")+" : "+ строка(строкаКонтрагент.Контрагент); //+++ 18.07.2017 +++ 04.02.2019
