...
Процедура КоманднаяПанельФормыФормированиеЗаказов(Кнопка)
	...
	//ЗначениеЯчейкиНоменклатура=ЭлементыФормы.ПолеТабличногоДокумента.Область("R"+Строка(сч)+"C"+Строка(НомерКолонкиКод));		
	//ЗначениеЯчейкиКоличество=ЭлементыФормы.ПолеТабличногоДокумента.Область("R"+Строка(сч)+"C"+Строка(НомерКолонкиКоличество));		
	//
	//Попытка
	//строкаТовар.Номенклатура=Справочники.Номенклатура.НайтиПоКоду(ЗначениеЯчейкиНоменклатура.Текст);
	//строкаТовар.Количество=	Число(ЗначениеЯчейкиКоличество.Текст);
	//Исключение
	//КонецПопытки;
