...
Процедура ОсновныеДействияФормыПолучить(Кнопка)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |"+?(Флажок7,"   И ЗадачиПользователя.ПометкаУдаления=Истина","");
...
Процедура Флажок7ПриИзменении(Элемент)
	Если Флажок7 тогда
	ЭлементыФормы.Флажок6.Заголовок = "Отменить Удаление";
	иначе
	ЭлементыФормы.Флажок6.Заголовок = "Удалить все задачи";
	КонецЕсли;
КонецПроцедуры
