...
Процедура ДействияФормыСформировать(Кнопка)
	...
	Если ПланФакт Тогда //Другая схема
		...
		Настройки.Структура[0].Колонки[1].Выбор.Элементы[3].Использование = Развернутый;
		Настройки.Структура[0].Колонки[1].Выбор.Элементы[2].Использование = Развернутый;
	...
	Иначе	
		...
		СхемаКомпоновкиДанных = ПолучитьМакет("БонусыПоставщиков");
		Настройки = СхемаКомпоновкиДанных.НастройкиПоУмолчанию;
		...
		Параметр = СхемаКомпоновкиДанных.Параметры.НачалоПериода;
		Если Параметр <> Неопределено Тогда
			Параметр.Значение = ПериодПланирования.ДатаНачала;
			Параметр.Использование = ИспользованиеПараметраКомпоновкиДанных.Всегда;
		КонецЕсли;
		...
		Результат = ЭлементыФормы.ТДПриходБонусов;
		Результат.Очистить();
	...
	//расчеты с покупателями
			...
			СхемаКомпоновкиДанных = ПолучитьМакет("РазвернутаяПокупатели");
		Настройки = СхемаКомпоновкиДанных.НастройкиПоУмолчанию;
		...
		Результат = ЭлементыФормы.ТДРасчетыСПокупателями;
		Результат.Очистить();
 	...
 	//расчеты с поставщиками
			...
			СхемаКомпоновкиДанных = ПолучитьМакет("РазвернутаяПоставщики");
		Настройки = СхемаКомпоновкиДанных.НастройкиПоУмолчанию;
		...
		Результат = ЭлементыФормы.ТДРасчетыСПоставщиками;
		Результат.Очистить();
		...
		СхемаКомпоновкиДанных = ПолучитьМакет("ДебиторкаПокупателей");
		Настройки = СхемаКомпоновкиДанных.НастройкиПоУмолчанию;
		...
		Результат = ЭлементыФормы.ТДДебиторка;
		Результат.Очистить();
...
Процедура РазвернутыйПриИзменении(Элемент)
			СхемаКомпоновкиДанных = ПолучитьМакет("ПриходКомпоновка");
		Настройки = СхемаКомпоновкиДанных.НастройкиПоУмолчанию;
