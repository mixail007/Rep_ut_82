...
Функция СоздатьСтруктуру()
	...
	Тест.Вставить("Язык", ТипСкрипта);
	Тест.Вставить("ФормаРедактирования", "Форма_VBS");
	Возврат Тест;
КонецФункции
...
Процедура ЗаполнитьИзСтруктуры(СтруктураТеста) Экспорт 
	...
	КонецЕсли;
	Если СтруктураТеста.Свойство("Язык") Тогда
		ТипСкрипта = СтруктураТеста.Язык;
	КонецЕсли;
...
Процедура ПриОткрытии()
	...
	Если Не ЗначениеЗаполнено(ТипСкрипта) Тогда
		ТипСкрипта = "VBScript";
	КонецЕсли;
