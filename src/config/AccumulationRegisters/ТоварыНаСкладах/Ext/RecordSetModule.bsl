...
//14.12.2016 задача №16950 все резервы БЕЗ этого заказа! =====================================================
	...
	|(ВЫБРАТЬ
	|	рез.Номенклатура, рез.Склад, рез.КоличествоОстаток 
	|из	РегистрНакопления.РезервНаСкладах.Остатки( "+?(флНеоперативно,"&ДатаСреза","")+" ,
	|		Номенклатура В (" + ТекстЗапросаСписокНоменклатуры + ")
	...
	//23.03.2017	
	+") как рез
	//+++ 30.10.2018 ---- ЕСТЬ минусы по резервам?! ----------
