...
//+++ 26.11.2018 - ВКЛючено условие проверка предоплаты - ДЛЯ ВСЕХ клиентов по всем договорам Предоплаты (без *) и не Отсрочка до 14 дней
	//если не включена ЕстьПодписаннаяСлужебнаяЗаписка
	Если не ОбъектКонтрагент.ЕстьПодписаннаяСлужебнаяЗаписка тогда
		
		//++++ 26.11.2018 тип: предоплата, но в названии: Отсрочка до 14 дней
		дог1Отсрочка  = Найти( нрег(дог1.Наименование),"отсрочка" )>0; 
