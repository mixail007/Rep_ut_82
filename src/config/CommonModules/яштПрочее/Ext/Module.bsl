...
Процедура ПроверитьРезервы(Объект, Отказ, таблПост=неопределено, ЭтоПроведениеИзЗаказа=ЛОЖЬ) Экспорт
	...
	разрешенСерый  = (ОбъектКонтрагент.Экспорт или Объект.РазрешитьГрузитьТоварыИзСтопЛиста или ОбъектКонтрагент.ВыгружатьСерыйСписокВTerminal); //в контрагенте
	разрешенЧерный = (ОбъектКонтрагент.Экспорт или Объект.РазрешитьГрузитьТоварыИзСтопЛиста или ОбъектКонтрагент.ВыгружатьЧерныйСписокВTerminal); //ТОЛЬКО в заказах  или Резерв для ИМ
