...
//---------------- Питер --------------
	...
	впути=1; 
	Если Сезон и дн=6 тогда
		впути=2;
	иначеЕсли дн=5 тогда
		впути=3;//пятница - прибытие в следующий понедельник
	КонецЕсли;
	стр1 = табл.Добавить(); 
...
//---------------- РнД --------------
	...
	Если (не Сезон и (дн=1 или дн=5 или дн=8) )
		...
		если не Сезон  и дн=5 тогда впути=3;//пятница - прибытие в следующий понедельник	 
...
//---------------- Ект --------------
	...
	впути=?(дн=4 или дн=5, 4, 3); //пятница - прибытие в следующий понедельник	 
...
//---------------Москва - на следующий день!--------------
	...
	впути= 1; //пятница - прибытие в следующий понедельник	 
