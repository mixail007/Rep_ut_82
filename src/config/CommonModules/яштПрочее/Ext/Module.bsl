...
//+++ 23.10.2018 +++ 
функция НельзяОбъединятьНеПодтвержденныйЗаказВКоторомЕстьТоварыСтопЛиста( Зак1 ) Экспорт
	...
	|	И ЗаказПокупателяТовары.Ссылка.РазрешитьГрузитьТоварыИзСтопЛиста = ЛОЖЬ
