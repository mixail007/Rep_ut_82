...
Ключ = "582c6465-86fb-4bb6-8252-3f8bb49994ff"; // Key#2  ogorodnikov@yst.ru	   - 25 000 в день
Координаты = "";	

Адрес2 = стрЗаменить(Адрес,"~"," ");
Адрес2 = стрЗаменить(Адрес2,"  "," ");
Адрес2 = стрЗаменить(Адрес2," ","%20");
ПутьНаСервере = "/1.x/?apikey="+Ключ+"&geocode=" + Адрес2 + "&results=1";
    Попытка
