	 ...
	 //+++)
				...
				//|			ПО ЗаданиеНаОтгрузкуЗаказыПокупателей.Реализация = ПеремещениеТоваров.Перемещение
			     ...
			     |			ПО ЗаказыВПутиНаФилиалы.ПеремещениеСсылка = ЗаданиеНаОтгрузкуЗаказыПокупателей.ЗаказПокупателя
	       	     ...
	       	     |			ЛЕВОЕ СОЕДИНЕНИЕ (выбрать ДокПеремещение.Ссылка,  ДокПеремещение.Перемещение, ДокПеремещение.Проведен из Документ.ПеремещениеТоваров как ДокПеремещение
				 |				ГДЕ ДокПеремещение.ПометкаУдаления = ЛОЖЬ 
				 |				И ДокПеремещение.Перемещение в (выбрать вт.Реализация из ЗаданиеНаОтгрузкуЗаказыПокупателей как вт
				 |													где вт.Реализация ССЫЛКА документ.ПеремещениеТоваров)     ) КАК ПеремещениеТоваров
	              |			ПО ЗаданиеНаОтгрузкуЗаказыПокупателей.Реализация = ПеремещениеТоваров.Перемещение
         		//+++)
	              |
	              |СГРУППИРОВАТЬ ПО
