...
//11 и 7 несовместимы! поэтому остаются ТОЛЬКО 11 вариантов:
	//4(1)= 7,11,с,ч, 
	//5(2)= 11с,11ч, 7с, 7ч, сч 
	//2(3)= 11сч; 7сч  
	
Запрос = Новый Запрос;
Запрос.Текст = "ВЫБРАТЬ
|	выбор когда НоменклатураИмпорт.ЧерныйЛист тогда ""Black"" иначе ""Gray"" как РезервКод,
