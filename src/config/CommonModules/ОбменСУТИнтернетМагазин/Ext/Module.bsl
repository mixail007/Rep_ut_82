...
//02.10.2018 - для фильтров по видуТовара, Производителям, Ном.Группе -> Шины - 8000 по наличию +++ 26.03.2019 - Nmax увеличено до 10 млн.
Nmax = 10100100; N = ?(СписокНоменклатуры=Неопределено, 152000, СписокНоменклатуры.Количество() ); 
