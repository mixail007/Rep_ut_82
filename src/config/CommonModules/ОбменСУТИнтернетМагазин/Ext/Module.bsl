...
Пока Выборка.Следующий() Цикл
	...
	Запрос = Новый Запрос;
	Если Основание.АвтокомплектацияСУчетомАналогов Тогда
		
		//После конструктора запроса: 
		//в АналогиНоменклатуры ГДЕ надо добавить строку отбора:
		// | //НеУчитыватьДискиВПаллетах  И НЕ Аналоги.Аналог В (ВЫБРАТЬ ДискиВПаллетах.Номенклатура ИЗ ВТ_ДискиВПаллетах как ДискиВПаллетах)
				   ...
				   |////////////////////////////////////////////////////////////////////////////////
					|ВЫБРАТЬ РАЗЛИЧНЫЕ
						  ...
						  // |	НЕ Аналоги.Аналог В (ВЫБРАТЬ вт.Номенклатура ИЗ ВТ_ЧерныйСписок КАК ВТ)
						   ...
						   |//НеУчитыватьДискиВПаллетах НЕ Аналоги.Аналог В (ВЫБРАТЬ ДискиВПаллетах.Номенклатура ИЗ ВТ_ДискиВПаллетах КАК ДискиВПаллетах)
						   |;
			               |////////////////////////////////////////////////////////////////////////////////
			               |ВЫБРАТЬ
