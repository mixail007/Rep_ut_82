...
//02.10.2018 - для фильтров по видуТовара, Производителям, Ном.Группе -> Шины - 8000 по наличию
Nmax = 11000; N = ?(СписокНоменклатуры=Неопределено, 152000, СписокНоменклатуры.Количество() ); 
