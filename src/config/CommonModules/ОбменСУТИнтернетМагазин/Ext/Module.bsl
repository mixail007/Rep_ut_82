...
функция ПолучитьстатусыЗаказов(списокЗаказов) Экспорт
	...
	Если СписокЗаказов.Количество()=1 тогда
		//14.12.18 Смирнов //Поле объекта не обнаружено (Значение)
		//Запрос.УстановитьПараметр("ДатаМин", НачалоДня(СписокЗаказов[0].Значение.Дата) ); // все документы должны быть позже заказа
		Запрос.УстановитьПараметр("ДатаМин", НачалоДня(СписокЗаказов[0].Дата) ); // все документы должны быть позже заказа
