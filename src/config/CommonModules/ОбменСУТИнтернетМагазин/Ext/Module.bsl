...
процедура sim_ВыгрузитьПродукты(остНом, путь="") Экспорт
	...
	остНом.Свернуть("НоменклатураКод, Номенклатура, ВидТовара, ПроизводительКод, МодельКод, ТипоразмерКод, СтранаПроисхождения,   Вид, Артикул, Weight, Volume, Завод, Цвет"); //+++ 10.01.2019
