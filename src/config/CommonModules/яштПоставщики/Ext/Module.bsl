...
ФайлРезультата = "c:\berg_yar.mxl";
  ...
  Табл2 = новый ТаблицаЗначений;
   Табл2.Колонки.Добавить("Номенклатура", "Номенклатура", новый ОписаниеТипов("СправочникСсылка.Номенклатура") );
   Табл2.Колонки.Добавить("Количество");
   Табл2.Колонки.Добавить("Цена");
   
   Табл2.Колонки.Добавить("Артикул");
   Табл2.Колонки.Добавить("Производитель","Производитель", новый ОписаниеТипов("СправочникСсылка.Производители") ); //для установки цен
