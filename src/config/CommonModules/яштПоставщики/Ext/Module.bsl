...
//+++(
	...
	ПолучитьСпискиОграниченийПоАксам(СписокНомГр, СписокПапок, СписокНоменклатуры);
...
процедура ПолучитьСпискиОграниченийПоАксам(СписокНомГр, СписокПапок, СписокНоменклатуры)
...
//====================================================================
	...
	СписокПапок = Новый СписокЗначений;
	СписокНоменклатуры = Новый СписокЗначений;
	ПолучитьСпискиОграниченийПоАксам(СписокНомГр, СписокПапок, СписокНоменклатуры); //+++ 24.09.2018
		...
		//20.02.2018 ---- п.8 - цикл по адресам ---------------------------
			для каждого стр1 из таблСписЗак цикл
				...
				Если текстОшибки1<>"" тогда //+++ 27.03.2018
					...
					Сообщить(текстОшибки1,СтатусСообщения.Внимание);
					#КонецЕсли
					//18.08.2018 - выключено логирование! 
