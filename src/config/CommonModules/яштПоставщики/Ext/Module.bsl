...
Если Печатать = Ложь и ПроверитьЦены = Ложь  тогда 
	для i=0 по масТов.Количество()-1 цикл
		...
		стр2.Производитель = СокрЛП(товар.Производитель.ПолноеНаименование); //+++ 22.06.2018  GENERALMOTORS >> "GENERAL MOTORS"
...
Запрос.Текст = "ВЫБРАТЬ
			   ...
			   //+++ 18.07.2018 - исключение товаров БЕЗ комплектующих!
               ...
               |	И не (КомплектующиеНоменклатуры.Комплектующая is Null)";
