...
ФайлРезультата = "c:\berg_yar.mxl";
  ...
  Табл2 = новый ТаблицаЗначений;
   Табл2.Колонки.Добавить("Номенклатура", новый ОписаниеТипов("СправочникСсылка.Номенклатура") );
   Табл2.Колонки.Добавить("Количество");
   Табл2.Колонки.Добавить("Цена");
   Табл2.Колонки.Добавить("Артикул");
   Табл2.Колонки.Добавить("Производитель",новый ОписаниеТипов("СправочникСсылка.Производители") ); //для установки цен
...
КонецЕсли;
	...
	//----------------нужен код поставщика?-----------------	
	  ...
	  //---------------нужен производитель--------------------  
	  ЗагрузитьЦеныВДокумент(Табл2, Берг); //17.05.2018 - есть таблица
    КонецЕсли;
