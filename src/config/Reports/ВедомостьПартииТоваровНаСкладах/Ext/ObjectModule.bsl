...
//	ОбщийОтчет.мНаДату = Ложь;
	ОбщийОтчет.мНазваниеОтчета = "Ведомость по партиям товаров на складах";
	
	СтруктураПредставлениеПолей = Новый Структура;
	МассивОтбора = Новый Массив;
	
	ЗаполнитьНачальныеНастройкиПоМакету(ПолучитьМакет("ПараметрыОтчетовПартииТоваровКомпании"), СтруктураПредставлениеПолей, МассивОтбора, ОбщийОтчет, "ОстаткиИОбороты");
