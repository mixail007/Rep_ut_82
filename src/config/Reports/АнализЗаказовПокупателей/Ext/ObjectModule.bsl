...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.РасчетыСКонтрагентами.Обороты(, &ДатаОтчета) КАК РасчетыСКонтрагентами
	...
	|
	|ИЗ
	|	РегистрНакопления.РасчетыСКонтрагентами.ОстаткиИОбороты(,&ДатаОтчета)        КАК РасчетыСКонтрагентами
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|	(ВЫБРАТЬ
	|		ЗаказПокупателя, 
	|		СУММА(КоличествоПриход) КАК КоличествоПриход, 
