Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	Текст = "ВЫБРАТЬ
	        ...
	        |	ВЫБОР
	        |		КОГДА ЕСТЬNULL(НачалоПроизводстваВРоссии.НачалоПроизводства, ДАТАВРЕМЯ(3000, 1, 1)) <= ТаблицаРегистра.ДокументПродажи.Дата
	        |			ТОГДА ""Россия""
	        |		ИНАЧЕ """"
	        ...
	        |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.НачалоПроизводстваВРоссии КАК НачалоПроизводстваВРоссии
	        |		ПО ТаблицаРегистра.Номенклатура = НачалоПроизводстваВРоссии.Номенклатура
	        |{ГДЕ
	        |	ТаблицаРегистра.ДоговорКонтрагента.Владелец.* КАК Покупатель,
	        |	ТаблицаРегистра.ДоговорКонтрагента.* КАК ДоговорКонтрагента,
	        |	ТаблицаРегистра.ЗаказПокупателя.* КАК ЗаказПокупателя,
...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок, ВысотаЗаголовка, ТолькоЗаголовок = Ложь) Экспорт
	...
	ДатаВремя = Истина; //***2018.11.08 в некоторых отчетах сделан ввод даты с временем, поэтому не нужно программно приводить ДатаКон к концу дня (Задача № 58079) 
