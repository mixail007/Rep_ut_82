...
Процедура СформироватьОтчет(Таб) Экспорт
	...
	Иначе
		ПредставлениеПараметра = "Параметр распределения: " + ПараметрРаспределения + ", в валюте упр.учета (" + СокрЛП(Константы.ВалютаУправленческогоУчета.Получить().Наименование) + ")";
	КонецЕсли; 
...
//  ТаблицаЗапросаПрошлыхСтадий  - ТаблицаЗначений,  прошлые занчения стадий контрагентов
// 
// Возвращаемое значение
//  НЕТ
...
//  ТаблицаЗапросаПрошлыхСтадий  - ТаблицаЗначений,  прошлые занчения стадий взаимоотношений с контрагентами
//
// Возвращаемое значение:
