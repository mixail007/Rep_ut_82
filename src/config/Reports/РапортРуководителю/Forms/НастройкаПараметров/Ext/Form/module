...
// Процедура - обработчик события начало выбора значения
//
Процедура ТабличноеПолеПараметровЗначениеНачалоВыбора(Элемент, СтандартнаяОбработка)
	
	// Элемент.ВыбиратьТип = Ложь;
	
КонецПроцедуры // ТабличноеПолеПараметровЗначениеНачалоВыбора()
