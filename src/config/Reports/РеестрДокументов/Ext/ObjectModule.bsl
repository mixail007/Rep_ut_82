...
//Перем мСтруктураСписокДействий Экспорт; // Список возможных действий над выбранными объектами
...
//// Список возможных действий над объектами
//мСтруктураСписокДействий = Новый Структура;
