...
Процедура СформироватьСписокВидовКИ() Экспорт
	...
	Пока 1 = 1 Цикл
		...
		Если ЗначениеНеЗаполнено(СтрокаТаблицы.ВидКонтактнойИнформации) Тогда
...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	Если ИспользоватьСвойстваИКатегории Тогда
		...
		ДобавитьВТекстСвойстваИКатегории(ТаблицаПолей, ТекстЗапроса, СтруктураПредставлениеПолей, мСоответствиеНазначений, ПостроительОтчета.Параметры, , ТекстПоляКатегорий, ТекстПоляСвойств, , , , , , мСтруктураДляОтбораПоКатегориям);
	...
	СсылкаОбъекта = Новый (ОбъектОтчета);
	Если ИспользоватьСвойстваИКатегории И НЕ ЗначениеНеЗаполнено(ТекстПоляСвойств) Тогда
