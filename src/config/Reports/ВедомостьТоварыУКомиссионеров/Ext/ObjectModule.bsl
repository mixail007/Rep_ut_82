Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ОбщийОтчет.ИмяРегистра = "ТоварыПереданные";
	ОбщийОтчет.мВыбиратьИмяРегистра = Ложь;
	ОбщийОтчет.НП = Новый НастройкаПериода;
	ОбщийОтчет.мСтруктураДляОтбораПоКатегориям = Новый Структура;

	ОбщийОтчет.мНазваниеОтчета = "Ведомость по товарам, отданным на реализацию";

	СтруктураПредставлениеПолей = Новый Структура;
	МассивОтбора = Новый Массив;

	ЗаполнитьНачальныеНастройкиПоМакету(ПолучитьМакет("ПараметрыОтчетовОстаткиТоваровУКомиссионеров"), СтруктураПредставлениеПолей, МассивОтбора, ОбщийОтчет, "ОстаткиИОбороты");
