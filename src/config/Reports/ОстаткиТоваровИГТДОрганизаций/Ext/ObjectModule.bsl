...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ЗаполнитьНачальныеНастройкиПоМакету(ПолучитьМакет("ПараметрыОтчетовТоварыОрганизаций"), СтруктураПредставлениеПолей, МассивОтбора, ОбщийОтчет, "СписокКроссТаблица");
	//ЗаполнитьНачальныеНастройкиПоМетаданнымрегистра(СтруктураПредставлениеПолей, МассивОтбора, ОбщийОтчет, "СписокКроссТаблица");
...
ОбщийОтчет.ИмяРегистра = "ТоварыОрганизаций";
ОбщийОтчет.мНазваниеОтчета = "Остатки товаров и номеров ГТД организаций";
