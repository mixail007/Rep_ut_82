Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	|	СУММА(ТаблицаРегистра.Номенклатура.ЕдиницаХраненияОстатков.Вес * ТаблицаРегистра.КоличествоОборот) КАК Вес,
	...
	ОбщийОтчет.ЗаполнитьПоказатели("Вес", "Вес", Истина, "ЧЦ=15; ЧДЦ=2");
