...
Процедура Выгрузить() Экспорт
    ...
    СтрокаСоединения= "Driver={PostgreSQL Unicode};Server="+Сервер+";Port=" + 
    Порт+";Database="+База+";Uid="+Пользователь+";Pwd="+Пароль+";STMT=utf8;currentSchema=ithaca";
...
Функция ЗаписатьЗаписи(НовыеЗаписи)
	...
	Для Каждого стр из НовыеЗаписи Цикл
		Если ПроверитьНаличиеАнглийскихБукв(стр.dst) = Ложь и ПроверитьНаличиеАнглийскихБукв(стр.src) = Ложь и Найти(стр.dst,"*") = 0 ТОгда
...
функция ПроверитьНаличиеАнглийскихБукв(Строка) 
