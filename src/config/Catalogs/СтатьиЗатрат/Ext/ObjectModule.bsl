...
Процедура ПередЗаписью(Отказ)
	...
	Если (ЭтотОбъект.ПринадлежитЭлементу(Справочники.СтатьиЗатрат.ПроцентыПоКредитамИЗаймам))
		ИЛИ (ЭтотОбъект.ПринадлежитЭлементу(Справочники.СтатьиЗатрат.РасчетноКассовоеОбслуживаниеВБанках)) Тогда
