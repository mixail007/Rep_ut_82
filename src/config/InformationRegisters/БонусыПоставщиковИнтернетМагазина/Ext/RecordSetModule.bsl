...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Таб =  ЭтотОбъект.Выгрузить(,"Период,Приоритет,Производитель,Модель,НоменклатурнаяГруппа,Диаметр");
	...
	Запрос.Текст="ВЫБРАТЬ
	             ...
	             |ГДЕ
	             |	НЕ (втЗаписей.Период, втЗаписей.Приоритет, втЗаписей.Производитель, втЗаписей.Модель, втЗаписей.НоменклатурнаяГруппа, втЗаписей.Диаметр) В
	             |				(ВЫБРАТЬ
