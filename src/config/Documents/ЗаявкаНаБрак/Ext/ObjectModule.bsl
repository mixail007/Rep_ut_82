...
функция УжеЕстьЗадачаПоЗаявкеНаИсполнителя(Исполнитель1=неопределено) экспорт
    рез = ЛОЖЬ;
...
//	|//табл 		И ЗадачиПользователя.РеквизитДляСогласования = ""СогласованВозвратКлиенту""
	    |
		|УПОРЯДОЧИТЬ ПО
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "//табл","");
