		...
		Пока выборкаТовар.Следующий() Цикл   //======================================================
			...
			Если выборкаТовар.КоличествоЗаказано=выборкаТовар.Количество или (колЗак=0) Тогда
				...
				Если ЗначениеЗаполнено(выборкаТовар.Номенклатура) 
					И выборкаТовар.Номенклатура.ВидТовара = перечисления.ВидыТоваров.Аксессуары Тогда
	...
	Пока ВыборкаНоменклатура.Следующий() Цикл     //======================================================
		...
		//+++( 25.07.2014 - для Аксессуаров нужен Артикул!
          Если ВыборкаНоменклатура.Номенклатура.ВидТовара = перечисления.ВидыТоваров.Аксессуары Тогда
             ...
             ОбластьНоменклатура.Параметры.Артикул = строка(ВыборкаНоменклатура.Номенклатура.ВидТовара)+": "+СокрЛП(ВыборкаНоменклатура.Номенклатура.Артикул);
          Иначе
             ОбластьНоменклатура =Макет.ПолучитьОбласть("Строка");
          КонецЕсли;
  	   //+++)
...
//+++( 27.07.2014 - проверка 
  ...
  КонецЕсли;
	...
	Если КоличествоЗаказаноИтого <> КоличествоЗаказаноПоГруппе Тогда
		#Если Клиент Тогда
		сигнал(); 	сигнал();
