...
Процедура ОбработкаЗаполнения(Основание)
	...
	ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.ЗаданиеНаПроизводствоДисков") Тогда
		...
		Комментарий                  = "По заданию " + Основание.Номер + " от " + Основание.Дата;
		////////////////////////////  Плановые цены
		Запрос = Новый Запрос;
		...
		ВыгрузкаЦен = Запрос.Выполнить().Выгрузить();
		////////////////////////////
		...
		Для Каждого ТекСтрокаТовары Из Основание.Товары Цикл			
			...
			НайденнаяСтрока                        = ВыгрузкаЦен.Найти(ТекСтрокаТовары.Номенклатура, "Номенклатура");
			Если  НайденнаяСтрока <> неопределено тогда
				НоваяСтрока.ПлановаяЦена               = НайденнаяСтрока.Цена;
				НоваяСтрока.ПлановаяСтоимость          = НайденнаяСтрока.Цена*ТекСтрокаТовары.Количество;
			КонецЕсли;
		КонецЦикла;
		Запрос.Текст = "ВЫБРАТЬ
