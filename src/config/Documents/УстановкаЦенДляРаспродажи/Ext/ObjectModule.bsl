...
Процедура ПроверитьЗаполнениеШапки(СтруктураШапкиДокумента, Отказ, Заголовок)
	...
	СтруктураОбязательныхПолей = Новый Структура("ТипЦенКонтрагента");
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрокаТовары Из Товары Цикл
		// регистр ЦеныДляРаспродажи 
		Движение = Движения.ЦеныДляРаспродажи.Добавить();
		Движение.Период = ?(ЗначениеЗаполнено(ДатаНачала),ДатаНачала,Дата);
		Движение.Номенклатура = ТекСтрокаТовары.Номенклатура;
		Движение.Цена = ТекСтрокаТовары.Цена;
	//	Движение.ЗаписьАктивна = Истина;
		
		//+++ 26.10.2015 - ЗаписьАктивна = Истина если валюта USD!
		//для рублей - ЛОЖЬ!
		Движение.ЗаписьАктивна = (ТекСтрокаТовары.Валюта.Код <> "643");
