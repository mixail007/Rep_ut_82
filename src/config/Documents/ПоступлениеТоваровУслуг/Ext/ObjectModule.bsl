...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если мПроведениеИзФормы тогда
		Если ДоговорКонтрагента.ТипДоговора = Справочники.ТипыДоговоров.ФормулаАвтоПлюс ИЛИ Подразделение.Код = "00171" Тогда
			ЗарегистрироватьОбъектФАП(ЭтотОбъект,Отказ,мПроведениеИзФормы);
		Иначе
