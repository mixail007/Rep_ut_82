...
Процедура ПроверитьЗаполнениеТабличнойЧастиПоОплатам(ТаблицаПоОплатам, Отказ, Заголовок)
	...
	// Укажем, что надо проверить:
	СтруктураОбязательныхПолей = Новый Структура("ВидЦенности, Покупатель, СчетФактура, СтавкаНДС, ДокументОплаты");
...
Процедура ДвиженияПоРегистрам(ТаблицаПоОплатам, Отказ, Заголовок);
	...
	Для Каждого ТекСтрокаОплат Из ТаблицаПоОплатам Цикл
		...
		Движение.Событие = 			Перечисления.СобытияПоНДСПродажи.Оплата;
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	СтруктураПолей.Вставить("ДоговорКонтрагента",	"СчетФактура.ДоговорКонтрагента");
