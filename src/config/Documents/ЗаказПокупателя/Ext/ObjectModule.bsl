...
процедура  ДвиженияПоЗаказыПокупателяСезонные(СтруктураШапкиДокумента, ТаблицаПоТоварам)
	...
	ЭлементБлокировки.ИсточникДанных = ЭтотОбъект.Товары; //16.07.2018 - для разделения по товарам!
	ЭлементБлокировки.ИспользоватьИзИсточникаДанных("Аналог", "Номенклатура");  	  
	ЭлементБлокировки.УстановитьЗначение("ЗаказПокупателя", Ссылка); 		//аналоги списываются ТОЛЬКО по ЭТОМУ Заказу! ссылка уже есть!
	//ЭлементБлокировки.УстановитьЗначение("Подразделение",Подразделение);  //! подразделение из выборки - по сезонному заказу ! 
	ЭлементБлокировки.УстановитьЗначение("Контрагент",Контрагент);
	Блокировка.Заблокировать();
	//---------------------ИЛИ все товары (без заказа!)------------------------------------
	ЭлементБлокировки = Блокировка.Добавить("РегистрНакопления.ЗаказыПокупателейСезонные");
	ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;
	ЭлементБлокировки.ИсточникДанных = ЭтотОбъект.Товары; //16.07.2018 - для разделения по товарам!
