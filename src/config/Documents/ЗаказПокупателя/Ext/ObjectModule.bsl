...
//+++ 28.06.2018 - убрано навсегда, работает другая схема!	
	...
	Если Не Отказ Тогда
		...
		//+++ 02.04.2019 - [V]Проверен -  надо делать движения, иначе НЕ ДЕЛАЕМ движений!!! task/1745
	//ИЛИ это заказ стороннему поставщику!!!
		Если ЭтотОбъект.Проверен или НЕ ЭтотОбъект.Поставщик.Пустая() тогда 
