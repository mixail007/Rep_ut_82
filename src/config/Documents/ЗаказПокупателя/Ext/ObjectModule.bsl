...
//изменение номера в новом году
	...
	Если ((ВводитьТолькоПеремещение = Истина 
		...
		ИЛИ ДоговорКонтрагента.ТипДоговора = Справочники.ТипыДоговоров.ПеремещениеОТХ)  //*** с 23.08.2018 не только заказы на филиалы, но и перемещения на отх
		и ТипЗаказа <> 13 
...
Процедура ЗаполнитьТабЧастьБонусы()
	...
	//			  |	НаборыДляПодарков.Подарок,
	//			  |	СУММА(НаборыДляПодарков.КоличествоПодарка) КАК КоличествоПодарка,
