...
Процедура ПроверитьНулевыеЦены(Отказ) экспорт
	...
	|        Иначе 
	//+++ 20.03.2018 для аксов и прочего...
	|			выбор когда ЗаказПокупателяТовары.Цена <1 тогда 1
	|				  когда ЗаказПокупателяТовары.Цена >1000000 тогда 1000000
	|				  иначе ЗаказПокупателяТовары.Цена Конец
	| Конец как ЦенаНов,
	|
