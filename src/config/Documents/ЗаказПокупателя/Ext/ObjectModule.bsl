...
//U-блокировки,будет установлена управляемая блокировка для всех комбинаций измерений в соответствии с записями набора записей. 
//не мешает чтению, но мешает записи UхU с такими же измерениями!
Движения.ЗаказыПокупателей.БлокироватьДляИзменения = Истина;   //28.11.2017 

	//26.06.2018  - X-блокировка НАДЁЖНЕЕ
