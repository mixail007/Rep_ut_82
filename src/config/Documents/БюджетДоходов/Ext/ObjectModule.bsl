Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	иначе
		...
		ДвиженияПриходДенегСДебиторкиВРегистр(НаборДвижений);
...
Процедура ДвиженияНачальныеОстаткиВРегистр(НаборДвижений)
	...
	яшт= Справочники.Организации.НайтиПоКоду("00001");
	  ...
	  НД = НачальныеОстаткиДебиторкаКредиторка.Выгрузить(,"Контрагент,НоменклатурнаяГруппа,ВидДоговора,Дебиторка,Кредиторка,Ответственный,Бренд");
	  НД.Свернуть("Контрагент,НоменклатурнаяГруппа,ВидДоговора,Ответственный,Бренд","Дебиторка,Кредиторка");
	Для каждого стр из НД цикл 
