...
Процедура ПриКопировании(ОбъектКопирования)
	...
	ID_ОблачнаяЛогистика = "";
	НомерЗаявки_ОблачнаяЛогистика = "";
	...
	Пока ТекстJSON <> "" Цикл
		...
		Иначе
			Если ТипДанных = "Структура" Тогда
				...
				Если Найти("0123456789", Лев(ИмяЗначения, 1)) > 0 Тогда
					ИмяЗначения = "_" + ИмяЗначения;
				КонецЕсли;
...
Функция ЗаполнитьСтруктуруИзОтветаJSON(ТекстJSON) Экспорт 
