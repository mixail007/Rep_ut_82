...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
  ...
  Если  (ЭтоНовый()) Тогда 
		ТекущееПодразделение = ?(СчетОрганизации.Подразделение = Справочники.Подразделения.ПустаяСсылка(),Справочники.Подразделения.НайтиПоКоду("00005"), СчетОрганизации.Подразделение);
